...
from defense.our_new_defense.defgnn_defense_pipeline import run_defgnn_defense, evaluate_defgnn_defense 
...
def main2(mode='balanced', include_defense=True):
    """
    Comprehensive attack and defense pipeline
    ...
    if include_defense:
        ...
        vflip, defended_embeddings, defense_metrics = run_defgnn_defense(
            partyA=partyA,
            partyB=partyB,
            partyC=partyC,
            server=server,
