...
from .defgnn_defense import DEFGNNDefense
...
def run_defgnn_defense(partyA, partyB, partyC, server,HA,HB,HC,
                      XA, XB, XC, edge_index, y,
                      train_mask, test_mask,
                      threshold=2.0,
                      mae_epochs=20,
...
def evaluate_defgnn_defense(vflip, partyA, partyB, partyC, server,
                           XA, XB, XC, edge_index, y,
